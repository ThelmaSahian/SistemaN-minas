...
<main class="main">
    <div class="container2">
        ...
        <hr>
        <div class="botones">
            <button type="button" onclick="location.href='regCont.jsp'" class="btn">Anterior</button>
            <button type="button" onclick="location.href='index.jsp'" class="btn">Guardar</button>
